...
for i in range(max_lines):
    ...
    # Correct alignment:
    # Column widths: ID:3, P:2, Summary:summary_width, Type:6, Branch:branch_width
    # Separator spaces: 4 spaces between 5 columns
    
    # ID:3, P:2, Summary:summary_width, Type:6, Branch:branch_width
