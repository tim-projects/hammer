...
for i in range(max_lines):
    ...
    # Correct columns: ID(3), P(2), Type(6)
    # The current issue is that when i=0, the formatting is right.
    # When i>0, the summary_lines and branch_lines print, but the padding in f-string is missing.
    # Let's use format explicitly for everything.
