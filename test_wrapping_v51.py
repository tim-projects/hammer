...
for i in range(max_lines):
    ...
    # Construct with explicit spacing
    # ID=3, P=2, Type=6
    ...
    # If summary is 30, indices 0-29 are filled. Index 30 is the space.
    # So index 31-36 is the Type column. Correct.
    # It looks correctly aligned.
    # Maybe the issue is simple wrapping of branch column?
    print(f"|{row}|")
