...
Commands:
  ...
  sync [branches...]         - Sync branches in order: testing → staging → main
...
def cmd_merge(src_input, target):
    ...
    info(f"Preparing to merge {src} → {target}")
