...
for i in range(max_lines):
    ...
    # The columns: id(3), p(2), type(6)
    # i=0: id_str(3) + space + p_str(2) + space + summary_lines[0] + space + type(6) + space + branch_lines[0]
    # i=1: space(3) + space + space(2) + space + summary_lines[1] + space + space(6) + space + branch_lines[1]
