...
for i in range(max_lines):
    ...
    id_col = f"{id_str:>3}" if i == 0 else "   "
    p_col = f"{p_str:>2}" if i == 0 else "  "
    type_col = f"{type_str:<6}" if i == 0 else "      "
    print(f"{id_col} {p_col} {s_line:<{summary_width}} {type_col} {b_line:<{branch_width}}")
