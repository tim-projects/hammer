...
for i in range(max_lines):
    ...
    # Try using exact format strings. The issue seems to be spaces vs empty string.
    # The f-string is correct, it prints exactly how many spaces it needs.
    # The problem is that summary_lines[i] or b_line might contain spaces? No, textwrap doesn't add spaces.
    
    # Try printing without format at all to debug
