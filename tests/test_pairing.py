...
class TestTaskPairing(unittest.TestCase):
    ...
    def test_task_pairing(self):
        # Create a task
        cmd = [
            "python3", self.tasks_script, "create", "New Feature Implementation",
            "--story", "As a user, I want a new feature for the application.",
            "--tech", "Python, Testing, and automated workflows.",
            "--criteria", "Test criteria must be long enough.",
            "--plan", "1. Do work for this new feature."
        ]
        ...
        self.assertIn("Created: [2] task | Write user tests for 1: New Feature Implementation", result.stdout)
