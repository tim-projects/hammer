...
for i in range(max_lines):
    ...
    # ID:3, P:2, Type:6
    # Correct alignment:
    # i=0: id_str(3) + " " + p_str(2) + " " + s_line(30) + " " + type_str(6) + " " + b_line(25)
    # The summary width is 30.
    # The type width is 6.
    
    # When i>0:
    # We need to preserve the columns: 3 + 1 + 2 + 1 = 7 spaces for the prefix
    # Summary(30) + space(1) + Type(6) + space(1) + branch(25)
