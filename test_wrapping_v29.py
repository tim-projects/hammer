...
for i in range(max_lines):
    ...
    # Correct alignment:
    # Column widths: ID:3, P:2, Type:6
    # Padding:
    # i=0: id_str(3) + space + p_str(2) + space + summary(width) + space + type(6) + space + branch(width)
    # i>0: 3spaces + space + 2spaces + space + summary(width) + space + 6spaces + space + branch(width)
